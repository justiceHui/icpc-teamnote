  ...
  for(int s=0; s<n; s++){
    ...
    while(seen[u] < 0){
      ...
      if(seen[u] == s){ // found cycle, contract
        Node* nd = 0; int end = qi, time = uf.time();
